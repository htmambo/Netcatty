...
const en: Messages = {
  ...
  // Settings > System > GPU
  'settings.gpu.title': 'GPU Acceleration',
  'settings.gpu.description': 'Configure Chromium GPU rendering settings. Changes require a restart to take effect.',
  'settings.gpu.disableGpu': 'Disable GPU acceleration',
  'settings.gpu.disableGpuDesc': 'Disables hardware GPU rendering. May fix display or rendering issues on some systems.',
  'settings.gpu.disableBlendFuncExtended': 'Disable advanced blend functions',
  'settings.gpu.disableBlendFuncExtendedDesc': 'Disables extended blend functions (BlendFuncExtended). May be needed for compatibility with some GPUs.',
  'settings.gpu.useAngle': 'Use ANGLE rendering backend',
  'settings.gpu.useAngleDesc': 'Use ANGLE instead of native OpenGL. Common values: "opengl", "swiftshader", "swiftshader_webgl".',
  'settings.gpu.apply': 'Apply & Restart',
  'settings.gpu.applySuccess': 'Settings saved. Please restart the app for changes to take effect.',
  ...
  // Vault Credentials
  'vault.credentials.title': 'Credentials',
  'vault.credentials.add': 'Add Credential',
  'vault.credentials.addNew': 'Add New Credential',
  'vault.credentials.label': 'Label',
  'vault.credentials.labelPlaceholder': 'e.g., GitHub, AWS Console',
  'vault.credentials.username': 'Username',
  'vault.credentials.usernamePlaceholder': 'Username or email',
  'vault.credentials.password': 'Password',
  'vault.credentials.passwordPlaceholder': 'Password',
  'vault.credentials.empty': 'No credentials saved yet',
  'vault.credentials.emptyHint': "Click 'Add Credential' to store your first credential",
  'vault.credentials.edit': 'Edit Credential',
  'vault.credentials.noUsername': '(no username)',
  'vault.credentials.copyPassword': 'Copy password',
  'vault.credentials.labelRequired': 'Label is required',
  'vault.credentials.passwordCopied': 'Password copied to clipboard',
  'vault.credentials.copyPasswordFailed': 'Failed to copy password',
  'vault.credentials.saveFailed': 'Failed to save credential',
  'vault.credentials.deleteFailed': 'Failed to delete credential',
  ...
  'database.noTablesFound': 'No tables found',
  'database.selectFromTable': 'Select from table',
  'database.copySelect': 'Copy SELECT',
  'database.copyInsert': 'Copy INSERT',
  'database.copyTableName': 'Copy table name',
  'database.refreshSchema': 'Refresh Schema',
  'database.showSchema': 'Show Schema',
  'database.hideSchema': 'Hide Schema',
  'database.searchTables': 'Search tables...',
  'database.loadingSchema': 'Loading schema...',
  'database.execute': 'Execute',
  'database.queryPlaceholder': 'SELECT * FROM ... LIMIT 100;',
  'database.noResultsYet': 'No results yet',
  'database.executeQueryHint': 'Press Ctrl+Enter or click Execute',
  'database.queryTooLong': 'Query exceeds maximum length',
  'database.queryError': 'Query Error',
  'database.noRowsReturned': 'No rows returned',
  'database.exportResults': 'Export Results',
  'database.doubleClickCopyCell': 'Double-click a cell to copy',
  'database.resultsTruncated': 'Results truncated to {count} rows',
  'database.previousPage': 'Previous',
  'database.nextPage': 'Next',
  'database.pageStatus': 'Page {page}',
  'database.pageStatusWithTotal': 'Page {page} / {total}',
  'database.rowRange': '{start}-{end} / {total}',
  'database.rowRangeUnknown': '{start}-{end}',
  'database.connected': 'Connected',
  'database.disconnected': 'Disconnected',
  'database.ready': 'Ready',
  'database.executingQuery': 'Executing {count} query',
  'database.databases': 'Databases',
  'database.noDatabases': 'No Databases',
  'database.noDatabasesDescription': 'Add a database connection to get started.',
  'database.addDatabase': 'Add Database',
  'database.searchPlaceholder': 'Search databases...',
  'database.connect': 'Connect',
  'database.disconnect': 'Disconnect',
  'database.error': 'Error',
  'database.testConnection': 'Test Connection',
  'database.noResults': 'No results found',
  'database.editDatabase': 'Edit Database',
  'database.newConnection': 'New Connection',
  'database.connectionDetails': 'Connection Details',
  'database.label': 'Label',
  'database.labelPlaceholder': 'e.g., Production MySQL',
  'database.group': 'Group',
  'database.selectGroup': 'Select group...',
  'database.noGroup': 'No Group',
  'database.data': 'Data',
  'database.structure': 'Structure',
  'database.query': 'Query',
  'database.objectExplorer': 'Object Explorer',
  'database.filterObjects': 'Filter objects...',
  'database.redisTypes': 'Redis Types',
  'database.previewData': 'Preview Data',
  'database.openInQuery': 'Open in Query',
  'database.copyPreviewQuery': 'Copy Preview Query',
  'database.copyObjectName': 'Copy Object Name',
  'database.refreshData': 'Refresh Data',
  'database.loadingPreview': 'Loading data preview...',
  'database.loadingObjectDetails': 'Loading structure details...',
  'database.usePreviewQuery': 'Use Preview Query',
  'database.noPreview': 'No preview available',
  'database.selectObjectHint': 'Select an object from the left list to preview its data.',
  'database.noStructure': 'No structure information available.',
  'database.message': 'Message',
  'database.rawResult': 'Raw Result',
  'database.noObjectsFound': 'No matching objects found.',
  'database.noObjectsAvailable': 'No objects available.',
  'database.defaultSchema': 'Default',
  'database.connection': 'Connection',
  'database.server': 'Server',
  'database.summary': 'Summary',
  'database.meta.name': 'Name',
  'database.meta.driver': 'Driver',
  'database.meta.target': 'Target',
  'database.meta.database': 'Database',
  'database.meta.user': 'User',
  'database.meta.version': 'Version',
  'database.meta.keys': 'Keys',
  'database.meta.schema': 'Schema',
  'database.meta.columns': 'Columns',
  'database.meta.rows': 'Rows',
  'database.meta.sampledKeys': 'Sampled Keys',
  'database.type': 'Type',
  'database.filePath': 'File Path',
  'database.filePathPlaceholder': '/path/to/database.db',
  'database.sqliteHelp': 'SQLite database file path',
  'database.networkSettings': 'Network Settings',
  'database.host': 'Host',
  'database.port': 'Port',
  'database.databaseName': 'Database Name',
  'database.authentication': 'Authentication',
  'database.username': 'Username',
  'database.usernamePlaceholder': 'Username',
  'database.password': 'Password',
  'database.passwordPlaceholder': 'Password',
  'database.passwordHelp': 'Stored securely using OS keychain',
  'database.redisSettings': 'Redis Settings',
  'database.redisDbIndex': 'Database Index',
  'database.mongodbSettings': 'MongoDB Settings',
  'database.replicaSet': 'Replica Set',
  'database.replicaSetPlaceholder': 'rs0',
  'database.authSource': 'Auth Source',
  'database.tlsSettings': 'TLS Settings',
  'database.tlsCa': 'CA Certificate',
  'database.tlsCaPlaceholder': 'Paste CA certificate...',
  'database.tlsCert': 'Client Certificate',
  'database.tlsCertPlaceholder': 'Paste client certificate...',
  'database.tlsKey': 'Client Key',
  'database.tlsKeyPlaceholder': 'Paste client key...',
  'database.tlsRejectUnauthorized': 'Reject unauthorized certificates',
  'database.sshTunnel': 'SSH Tunnel',
  'database.sshTunnelHost': 'SSH Tunnel Host',
  'database.selectSshTunnel': 'Select SSH tunnel...',
  'database.advancedSettings': 'Advanced Settings',
  'database.poolMin': 'Min Pool Size',
  'database.poolMax': 'Max Pool Size',
  'database.poolIdleTimeout': 'Idle Timeout (ms)',
  'database.poolIdleTimeoutHelp': 'Milliseconds to keep idle connections',
  'database.connectionSuccess': 'Connection successful',
  'database.connectionFailed': 'Connection failed',
  'database.saveFailed': 'Failed to save database configuration',
  'database.testConnectionHelp': 'Test the database connection',
  'database.createConnection': 'Create',

  // Filter builder
  // Filter builder
  'database.filter.label': 'Filter',
  'database.tabs.closeCurrent': 'Close',
  'database.tabs.closeOthers': 'Close Others',
  'database.tabs.closeAll': 'Close All',
  'database.filter.addCondition': 'Add Filter',
  'database.filter.clearAll': 'Clear All',
  'database.filter.apply': 'Apply Filter',
  'database.filter.hint': 'Click Add Filter to create a condition',
  'database.filter.column': 'Column',
  'database.filter.and': 'AND',
  'database.filter.or': 'OR',
  'database.filter.opGroup.comparison': 'Comparison',
  'database.filter.opGroup.text': 'Text',
  'database.filter.opGroup.set': 'Set',
  'database.filter.opGroup.null': 'Null',
  'database.filter.opGroup.range': 'Range',
  'database.filter.op.equals': '= equals',
  'database.filter.op.notEquals': '!= not equals',
  'database.filter.op.lessThan': '< less than',
  'database.filter.op.greaterThan': '> greater than',
  'database.filter.op.lessOrEqual': '<= less or equal',
  'database.filter.op.greaterOrEqual': '>= greater or equal',
  'database.filter.op.contains': 'LIKE contains',
  'database.filter.op.notContains': 'NOT LIKE not contains',
  'database.filter.op.inList': 'IN in list',
  'database.filter.op.notInList': 'NOT IN not in list',
  'database.filter.op.isNull': 'IS NULL',
  'database.filter.op.isNotNull': 'IS NOT NULL',
  'database.filter.op.between': 'BETWEEN range',
  'database.filter.group': 'Group',
  'database.filter.addGroup': 'Add Group',
  'database.pageSizeLabel': 'page',

  // Edit dialog
  'database.edit.confirmTitle': 'Confirm Cell Update',
  'database.edit.confirmMessage': 'Review the change before applying it to the database.',
  'database.edit.table': 'Table',
  'database.edit.column': 'Column',
  'database.edit.primaryKey': 'PK',
  'database.edit.valueChange': 'Value Change',
  'database.edit.oldValue': 'OLD',
  'database.edit.newValue': 'NEW',
  'database.edit.sqlPreview': 'SQL',
  'database.edit.cancel': 'Cancel',
  'database.edit.update': 'Update',
  'database.edit.updateSuccess': 'Cell updated successfully',
  'database.edit.updateFailed': 'Update failed',
  'database.copyCell': 'Copy Cell',
  'database.editCell': 'Edit Cell',
  ...
  'vault.groups.entriesCount': '{count} Entries',
  ...
  'hostDetails.savedCredentials.title': 'Saved Credentials',
  'hostDetails.savedCredentials.selectPlaceholder': 'Select a saved credential',
  'hostDetails.savedCredentials.noneAvailable': 'No saved credentials yet',
  'hostDetails.savedCredentials.saveCurrent': 'Save current password',
  'hostDetails.savedCredentials.saveDialogTitle': 'Save to Credentials',
  'hostDetails.savedCredentials.saveDialogDesc': 'Store the current username and password in the credentials list.',
  'hostDetails.savedCredentials.passwordRequired': 'Enter a password first',
  'hostDetails.savedCredentials.labelRequired': 'Credential label is required',
  'hostDetails.savedCredentials.saved': 'Credential saved',
  'hostDetails.savedCredentials.saveFailed': 'Failed to save credential',
  ...
  'keychain.filter.credential': 'CREDENTIALS',
