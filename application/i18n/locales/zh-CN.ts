...
const zhCN: Messages = {
  ...
  // Settings > System > GPU
  'settings.gpu.title': 'GPU 加速',
  'settings.gpu.description': '配置 Chromium GPU 渲染设置。更改需要重启应用才能生效。',
  'settings.gpu.disableGpu': '禁用 GPU 加速',
  'settings.gpu.disableGpuDesc': '禁用硬件 GPU 渲染。在部分系统上可解决显示或渲染问题。',
  'settings.gpu.disableBlendFuncExtended': '禁用高级混合函数',
  'settings.gpu.disableBlendFuncExtendedDesc': '禁用扩展混合函数（BlendFuncExtended）。部分显卡可能需要此选项以保持兼容性。',
  'settings.gpu.useAngle': '使用 ANGLE 渲染后端',
  'settings.gpu.useAngleDesc': '使用 ANGLE 替代原生 OpenGL。常用值："opengl"、"swiftshader"、"swiftshader_webgl"。',
  'settings.gpu.apply': '应用并重启',
  'settings.gpu.applySuccess': '设置已保存。请重启应用使更改生效。',
  ...
  // Vault Credentials
  'vault.credentials.title': '凭据',
  'vault.credentials.add': '添加凭据',
  'vault.credentials.addNew': '添加新凭据',
  'vault.credentials.label': '名称',
  'vault.credentials.labelPlaceholder': '例如：GitHub, AWS Console',
  'vault.credentials.username': '用户名',
  'vault.credentials.usernamePlaceholder': '用户名或邮箱',
  'vault.credentials.password': '密码',
  'vault.credentials.passwordPlaceholder': '密码',
  'vault.credentials.empty': '暂无保存的凭据',
  'vault.credentials.emptyHint': '点击"添加凭据"来存储您的第一个凭据',
  'vault.credentials.edit': '编辑凭据',
  'vault.credentials.noUsername': '（无用户名）',
  'vault.credentials.copyPassword': '复制密码',
  'vault.credentials.labelRequired': '请输入名称',
  'vault.credentials.passwordCopied': '密码已复制到剪贴板',
  'vault.credentials.copyPasswordFailed': '复制密码失败',
  'vault.credentials.saveFailed': '保存凭据失败',
  'vault.credentials.deleteFailed': '删除凭据失败',

  // Database
  'database.tables': '表',
  'database.views': '视图',
  'database.collections': '集合',
  'database.extensions': '扩展',
  'database.noTablesFound': '未找到表',
  'database.selectFromTable': '从表查询',
  'database.copySelect': '复制 SELECT',
  'database.copyInsert': '复制 INSERT',
  'database.copyTableName': '复制表名',
  'database.refreshSchema': '刷新结构',
  'database.showSchema': '显示结构',
  'database.hideSchema': '隐藏结构',
  'database.searchTables': '搜索表...',
  'database.loadingSchema': '加载结构中...',
  'database.execute': '执行',
  'database.queryPlaceholder': 'SELECT * FROM ... LIMIT 100;',
  'database.noResultsYet': '暂无结果',
  'database.executeQueryHint': '按 Ctrl+Enter 或点击执行',
  'database.queryTooLong': '查询超出最大长度',
  'database.queryError': '查询错误',
  'database.noRowsReturned': '无返回数据',
  'database.exportResults': '导出结果',
  'database.doubleClickCopyCell': '双击单元格复制',
  'database.resultsTruncated': '结果已截断至 {count} 行',
  'database.previousPage': '上一页',
  'database.nextPage': '下一页',
  'database.pageStatus': '第 {page} 页',
  'database.pageStatusWithTotal': '第 {page} / {total} 页',
  'database.rowRange': '{start}-{end} / {total}',
  'database.rowRangeUnknown': '{start}-{end}',
  'database.connected': '已连接',
  'database.disconnected': '已断开',
  'database.ready': '就绪',
  'database.executingQuery': '正在执行 {count} 个查询',
  'database.databases': '数据库',
  'database.noDatabases': '暂无数据库',
  'database.noDatabasesDescription': '添加数据库连接以开始使用。',
  'database.addDatabase': '添加数据库',
  'database.searchPlaceholder': '搜索数据库...',
  'database.connect': '连接',
  'database.disconnect': '断开连接',
  'database.error': '错误',
  'database.testConnection': '测试连接',
  'database.noResults': '未找到结果',
  'database.editDatabase': '编辑数据库',
  'database.newConnection': '新建连接',
  'database.connectionDetails': '连接详情',
  'database.label': '名称',
  'database.labelPlaceholder': '例如：生产环境 MySQL',
  'database.group': '分组',
  'database.selectGroup': '选择分组...',
  'database.noGroup': '未分组',
  'database.data': '数据',
  'database.structure': '结构',
  'database.query': '查询',
  'database.objectExplorer': '对象列表',
  'database.filterObjects': '筛选对象...',
  'database.redisTypes': 'Redis 类型',
  'database.previewData': '预览数据',
  'database.openInQuery': '打开到查询页',
  'database.copyPreviewQuery': '复制预览查询',
  'database.copyObjectName': '复制对象名',
  'database.refreshData': '刷新数据',
  'database.loadingPreview': '正在加载数据预览...',
  'database.loadingObjectDetails': '正在加载结构详情...',
  'database.usePreviewQuery': '使用预览查询',
  'database.noPreview': '暂无可预览内容',
  'database.selectObjectHint': '从左侧对象列表中选择一个对象以预览数据。',
  'database.noStructure': '暂无结构信息。',
  'database.message': '消息',
  'database.rawResult': '原始结果',
  'database.noObjectsFound': '未找到匹配对象。',
  'database.noObjectsAvailable': '暂无可用对象。',
  'database.defaultSchema': '默认',
  'database.connection': '连接',
  'database.server': '服务器',
  'database.summary': '概要',
  'database.meta.name': '名称',
  'database.meta.driver': '驱动',
  'database.meta.target': '目标',
  'database.meta.database': '数据库',
  'database.meta.user': '用户',
  'database.meta.version': '版本',
  'database.meta.keys': '键数量',
  'database.meta.schema': '架构',
  'database.meta.columns': '列数',
  'database.meta.rows': '行数',
  'database.meta.sampledKeys': '采样键数',
  'database.type': '类型',
  'database.filePath': '文件路径',
  'database.filePathPlaceholder': '/path/to/database.db',
  'database.sqliteHelp': 'SQLite 数据库文件路径',
  'database.networkSettings': '网络设置',
  'database.host': '主机',
  'database.port': '端口',
  'database.databaseName': '数据库名称',
  'database.authentication': '认证',
  'database.username': '用户名',
  'database.usernamePlaceholder': '用户名',
  'database.password': '密码',
  'database.passwordPlaceholder': '密码',
  'database.passwordHelp': '使用系统钥匙串安全存储',
  'database.redisSettings': 'Redis 设置',
  'database.redisDbIndex': '数据库索引',
  'database.mongodbSettings': 'MongoDB 设置',
  'database.replicaSet': '副本集',
  'database.replicaSetPlaceholder': 'rs0',
  'database.authSource': '认证源',
  'database.tlsSettings': 'TLS 设置',
  'database.tlsCa': 'CA 证书',
  'database.tlsCaPlaceholder': '粘贴 CA 证书...',
  'database.tlsCert': '客户端证书',
  'database.tlsCertPlaceholder': '粘贴客户端证书...',
  'database.tlsKey': '客户端密钥',
  'database.tlsKeyPlaceholder': '粘贴客户端密钥...',
  'database.tlsRejectUnauthorized': '拒绝未授权证书',
  'database.sshTunnel': 'SSH 隧道',
  'database.sshTunnelHost': 'SSH 隧道主机',
  'database.selectSshTunnel': '选择 SSH 隧道...',
  'database.advancedSettings': '高级设置',
  'database.poolMin': '最小连接池大小',
  'database.poolMax': '最大连接池大小',
  'database.poolIdleTimeout': '空闲超时 (毫秒)',
  'database.poolIdleTimeoutHelp': '空闲连接的保持时间（毫秒）',
  'database.connectionSuccess': '连接成功',
  'database.connectionFailed': '连接失败',
  'database.saveFailed': '保存数据库配置失败',
  'database.testConnectionHelp': '测试数据库连接',
  'database.createConnection': '创建',

  // Filter builder
  // Filter builder
  'database.filter.label': '筛选',
  'database.tabs.closeCurrent': '关闭',
  'database.tabs.closeOthers': '关闭其它',
  'database.tabs.closeAll': '全部关闭',
  'database.filter.addCondition': '添加筛选',
  'database.filter.clearAll': '清除全部',
  'database.filter.apply': '应用筛选',
  'database.filter.hint': '点击添加筛选来创建条件',
  'database.filter.column': '列',
  'database.filter.and': '且',
  'database.filter.or': '或',
  'database.filter.opGroup.comparison': '比较',
  'database.filter.opGroup.text': '文本',
  'database.filter.opGroup.set': '集合',
  'database.filter.opGroup.null': '空值',
  'database.filter.opGroup.range': '范围',
  'database.filter.op.equals': '= 等于',
  'database.filter.op.notEquals': '!= 不等于',
  'database.filter.op.lessThan': '< 小于',
  'database.filter.op.greaterThan': '> 大于',
  'database.filter.op.lessOrEqual': '<= 小于等于',
  'database.filter.op.greaterOrEqual': '>= 大于等于',
  'database.filter.op.contains': 'LIKE 包含',
  'database.filter.op.notContains': 'NOT LIKE 不包含',
  'database.filter.op.inList': 'IN 在列表中',
  'database.filter.op.notInList': 'NOT IN 不在列表中',
  'database.filter.op.isNull': 'IS NULL',
  'database.filter.op.isNotNull': 'IS NOT NULL',
  'database.filter.op.between': 'BETWEEN 范围',
  'database.filter.group': '分组',
  'database.filter.addGroup': '添加分组',
  'database.pageSizeLabel': '页',

  // Edit dialog
  'database.edit.confirmTitle': '确认单元格更新',
  'database.edit.confirmMessage': '在应用到数据库之前，请确认修改。',
  'database.edit.table': '表',
  'database.edit.column': '列',
  'database.edit.primaryKey': '主键',
  'database.edit.valueChange': '值变更',
  'database.edit.oldValue': '旧值',
  'database.edit.newValue': '新值',
  'database.edit.sqlPreview': 'SQL',
  'database.edit.cancel': '取消',
  'database.edit.update': '更新',
  'database.edit.updateSuccess': '单元格更新成功',
  'database.edit.updateFailed': '更新失败',
  'database.copyCell': '复制单元格',
  'database.editCell': '编辑单元格',
  'database.copySelection': '复制选中内容',

  'vault.groups.title': '分组',
  'vault.groups.total': '共 {count} 个',
  'vault.groups.hostsCount': '{count} 台主机',
  'vault.groups.entriesCount': '{count} 个条目',
  ...
  'hostDetails.savedCredentials.title': '已保存凭证',
  'hostDetails.savedCredentials.selectPlaceholder': '选择已保存凭证',
  'hostDetails.savedCredentials.noneAvailable': '暂时还没有已保存凭证',
  'hostDetails.savedCredentials.saveCurrent': '保存当前密码',
  'hostDetails.savedCredentials.saveDialogTitle': '保存到凭证列表',
  'hostDetails.savedCredentials.saveDialogDesc': '把当前用户名和密码保存到凭证列表中。',
  'hostDetails.savedCredentials.passwordRequired': '请先输入密码',
  'hostDetails.savedCredentials.labelRequired': '请输入凭证名称',
  'hostDetails.savedCredentials.saved': '凭证已保存',
  'hostDetails.savedCredentials.saveFailed': '保存凭证失败',
